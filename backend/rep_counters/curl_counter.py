...
class CurlCounter(BaseRepCounter):
    """Enhanced counter for bicep and hammer curls with dual-arm detection"""
    ...
    def __init__(self):
        ...
        self.min_curl_angle = 70   # More lenient - was too strict at 60
        self.min_extend_angle = 140  # More lenient - was too strict at 150
    ...
    def count_rep(self, landmarks):
        """
        Enhanced curl counting with dual-arm detection and better smoothing
        ...
        try:
            ...
            print(f"Error in enhanced curl counter: {e}")
            return self.counter, self.stage, None
